...
class BaseToolOutput(Serializable):
    """
    The LLM requires Tool output to be a str, but elsewhere we want Tool to return
    structured data normally. Simply wrap the Tool's return value with this class to
    satisfy both needs.
    """

    # Use pydantic v1 compatible field definitions
    data: Any
    format: str = None
    data_alias: str = ""
    extras: dict = {}
