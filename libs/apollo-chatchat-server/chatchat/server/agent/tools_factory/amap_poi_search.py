...
@regist_tool(title="AMap POI Search")
def amap_poi_search(location: str = Field(description="An 'actual place name' or a 'specific address'. Do not use abbreviations or aliases."),
                types: str = Field(description="POI type, for example shopping mall, school, hospital, etc.")):
