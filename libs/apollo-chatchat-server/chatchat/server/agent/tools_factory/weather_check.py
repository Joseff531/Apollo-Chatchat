"""
A simple single-parameter tool implementation used to query the current weather.
"""
import requests
...
@regist_tool(title="Weather Check")
def weather_check(
    city: str = Field(description="City name, including city and county, e.g. 'Xiamen'"),
):
