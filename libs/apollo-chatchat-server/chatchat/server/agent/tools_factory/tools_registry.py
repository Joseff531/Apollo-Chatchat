...
def format_context(self: BaseToolOutput) -> str:
    '''
    Format a ToolOutput containing knowledge base results into the string the LLM expects.
    '''
    context = ""
    docs = self.data["docs"]
    source_documents = []
    ...
    if len(source_documents) == 0:
        context = "No relevant documents found, please try again with different keywords."
    else:
