...
class KBService(ABC):
    def __init__(
        ...
        self.kb_info = kb_info or Settings.kb_settings.KB_INFO.get(
            knowledge_base_name, f"Knowledge base about {knowledge_base_name}"
        )
    ...
    def save_vector_store(self):
        """
        Save the vector store: FAISS is saved to disk, Milvus is saved to the database. PGVector is not yet supported.
        """
        pass
    ...
    def add_doc(self, kb_file: KnowledgeFile, docs: List[Document] = [], **kwargs):
        ...
        If docs is specified, the text will not be vectorized again, and the corresponding database entry will be marked custom_docs=True.
        """
    ...
    def update_doc(self, kb_file: KnowledgeFile, docs: List[Document] = [], **kwargs):
        """
        Update the vector store using the files in the content directory.
        If docs is specified, custom docs are used and the corresponding database entry is marked custom_docs=True.
        """
        if not self.check_embed_model()[0]:
            return False
    ...
    def update_doc_by_ids(self, docs: Dict[str, Document]) -> bool:
        ...
        If the value for a given doc_id is None, or its page_content is empty, the document is deleted.
        """
        if not self.check_embed_model()[0]:
            return False
    ...
    def list_docs(
        ...
        for x in doc_infos:
            ...
            if doc_info is not None:
                ...
                # You can choose to skip the current loop iteration or perform other operations
                pass
        return docs

    def get_relative_source_path(self, filepath: str):
        """
        Convert the file path to a relative path to ensure consistency at query time
        """
    ...
    def do_create_kb(self):
        """
        Subclasses implement their own logic for creating the knowledge base
        """
        pass
    ...
    def do_drop_kb(self):
        """
        Subclasses implement their own logic for deleting the knowledge base
        """
        pass
    ...
    def do_search(
        ...
        """
        Subclasses implement their own logic for searching the knowledge base
        """
        pass
    ...
    def do_add_doc(
        ...
        **kwargs,
        ...
        """
        Subclasses implement their own logic for adding documents to the knowledge base
        """
        pass
    ...
    def do_delete_doc(self, kb_file: KnowledgeFile):
        """
        Subclasses implement their own logic for deleting documents from the knowledge base
        """
        pass
    ...
    def do_clear_vs(self):
        """
        Subclasses implement their own logic for deleting all vectors from the knowledge base
        """
        pass
